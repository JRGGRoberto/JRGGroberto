...
My name is **Roberto** — I'm a developer with experience in **infrastructure** and **database administration (DBA)**.  
...
> 🇧🇷 [Versão em Português]([README.pt-BR.md](https://github.com/JRGGRoberto/JRGGroberto/blob/master/README.pt-BR.md))

---

### 👨‍💻 What I'm up to

- 🏢  Working at **UNESPAR [PROEC]** – Apucarana  
- 💻  Currently using: **PHP**, **JavaScript**, **Java**, **MySQL**  
- 🌱  Always learning — I explore any tech that crosses my path - Currently: Python and Azure Cloud
- 🚲  For on-site jobs, being close to home matters. For remote roles — let’s chat!
